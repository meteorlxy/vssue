...
- __Details__:
  ...
  The `client_secrect` intoduced in [OAuth2 spec](https://tools.ietf.org/html/rfc6749#section-2.3.1).

  It is the client secrect that generated by the platform. You will get it after you set up OAuth App.
